...
clear
%%%%%%%%%%%%
xlsfilename = 'OBLFA_GWO-03-02_16_23.xlsx';
...
for i=1:functioon_num
    ...
    % grid on
    % box on
    %     saveas(gcf,[xlsfilename,'-',Function_name],'fig')
    %     filename1= [xlsfilename,'-',Function_name];
    print([Function_name],'-dtiff', '-r300'); %<-Save as PNG with 300 DPI
