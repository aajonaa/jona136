% Backtracking Search Optimization Algorithm (BSA) modified by Jona 2024-1-25.
% 2024-2-5 for balance and diversity.

% This version is the same with BSA_map8.m but delete the commented code.
% This is the copy of the modBSA_e.
...
% I
% function [best_pos,Convergence_curve] = IBSA(N, Max_FEs, lb, ub, dim, fobj)

function [average_distance,Div,best_pos,Convergence_curve]=IBSA(N,Max_FEs,lb,ub,dim,fobj)

% function [bestFitness, best_pos, Convergence_curve, Time] = bmodBSA(N, Max_FEs, dim, A, trn, vald, TFid, classifierFhd)

    tic
    disp('BSA tackle your problem');
